...
const geoJsonData = [
  ...
  { name: "Bolivia", "alpha-2": "BO", "country-code": "068" },
  {
  ...
  { name: "Republic of the Congo", "alpha-2": "CG", "country-code": "178" },
  {
  ...
  { name: "Ivory Coast", "alpha-2": "CI", "country-code": "384" },
  ...
  { name: "Iran", "alpha-2": "IR", "country-code": "364" },
  ...
  { name: "North Korea", "alpha-2": "KP", "country-code": "408" },
  ...
  { name: "Laos", "alpha-2": "LA", "country-code": "418" },
  ...
  { name: "Moldova", "alpha-2": "MD", "country-code": "498" },
  ...
  { name: "Macedonia", "alpha-2": "MK", "country-code": "807" },
  ...
  { name: "Russia", "alpha-2": "RU", "country-code": "643" },
  ...
  { name: "Venezuela", "alpha-2": "VE", "country-code": "862" },
  { name: "Vietnam", "alpha-2": "VN", "country-code": "704" },
...
const geoJsonCountryNames = geoJsonData.map((country) => country.name);

// Find countries with different naming
const differentNamingCountries = dataCountries.filter(
  (country) => !geoJsonCountryNames.includes(country)
);

console.log("Countries with different naming:", differentNamingCountries);

// "Countries with different naming:"
// ["Individual Olympic Athletes","Trinidad","Curacao","Taiwan","Virgin Islands, US","Kosovo"]
